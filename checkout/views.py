...
def checkout(request):
        ...
        if order_form.is_valid():
            ...
            for item_id, item_data in bag.items():
                try:
                    ...
                    # if the item_data is an integer we know it doesn't have sizes if not we know it does
                    ...
                    # if the item has sizes we just need to iterate through and set the size and quantity for each line item
                    else:
    ...
    if not stripe_public_key:
        messages.warning(request, 'Stripe public key is missing. \
            Did you forget toi set it in your environment?')
...
def checkout_success(request, order_number):
    ...
    messages.success(request, f'Order successfuly processed! \
        Your order number is {order_number}. A confirmation message \
